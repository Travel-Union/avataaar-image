        ...
        <g id="Top/Long-Hair/Big-Hair" mask="url(#mask2)">
          <g transform="translate(-1.000000, 0.000000)">
            <g
              ...
              <use fill="${hairColorHex(avataaar)}" href="#path2" />
              ${hairColor(avataaar, "mask3")}
            </g>
            <path
        ...
        <g id="Top/Long-Hair/Dreads" mask="url(#mask2)">
          <g transform="translate(-1.000000, 0.000000)">
            <g
              ...
              <use id="No-Woman" fill="${hairColorHex(avataaar)}" href="#path2" />
              ${hairColor(avataaar, "mask1")}
              <path
