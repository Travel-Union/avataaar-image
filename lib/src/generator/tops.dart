    ...
    case TopType.NoHair:
      {
        ...
        <g id="Top/No-Hair" mask="url(#no_hair_mask)">
          <g transform="translate(-1.000000, 0.000000)">""" +
            facialHair(avataaar.top.facialHair) +
            """</g>
        </g>
      </g>""";
      }
        ...
        <g id='Top/Accesories/Hijab' mask='url(#hijab_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            ...
            <use
              id='Hijab-Mask'
              stroke='none'
              fill='${hatColorHex(avataaar)}'
              fill-rule='evenodd'
              href='#hijab_path2'
            />""" +
          hatColor(avataaar, "hijab_mask2") +
          """<path
          ...
          """<g
            ...
            <g
              ...
              <g transform='translate(48.000000, 3.000000)'>
                ...
                <use id='Turban-Mask' fill='${hatColorHex(avataaar)}' href='#turban_path3' />""" +
          hatColor(avataaar, "turban_mask3") +
          """</g>
              <path
      ...
      <g id="Top">
        ...
        <g
          ...
          <g
            ...
            <use id="hat-mask" fill="${hatColorHex(avataaar)}" href='#hat_path1' />""" +
          hatColor(avataaar, "hat_mask2") +
          """</g>
          <g id="hat-front">
            <use
              fill="black"
      ...
      <g id='Top'>
        ...
        >
          ...
          >
            ...
            <use id='Combined-Shape' fill='${hatColorHex(avataaar)}' href='#hat_path1' />""" +
          hatColor(avataaar, "hat_mask2") +
          """<rect
              id='color-dark'
              fill-opacity='0.2'
        ...
        <g id='Top/Long-Hair/Big-Hair' mask='url(#hair_mask2)'>
          <g transform='translate(-1.000000, 0.000000)'>
            <g
              ...
              <use fill='${hairColorHex(avataaar)}' href='#hair_path2' />""" +
          hairColor(avataaar, "hair_mask3") +
          """</g>
            <g
              id='Shadow'
              stroke-width='1'
        ...
        <g id='Top/Long-Hair/Bob' mask='url(#bob_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            <g
              ...
              <use id='Combined-Shape' fill='${hairColorHex(avataaar)}' href='#bob_path2' />""" +
          hairColor(avataaar, "bob_mask2") +
          """</g>""" +
          facialHair(avataaar) +
          accessorySvg(avataaar) +
          """</g>
        ...
        <g id='Top/Long-Hair/Curly' mask='url(#curly_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            ...
            <g
              ...
              <use id='Curly!' fill='${hairColorHex(avataaar)}' href='#curly_path2' />""" +
          hairColor(avataaar, "curly_mask2") +
          """</g>""" +
          facialHair(avataaar) +
          accessorySvg(avataaar) +
          """</g>
        ...
        <g id='Top/Long-Hair/Curvy' mask='url(#curvey_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            ...
            <g
              ...
              <use id='Hair-Mask' fill='${hairColorHex(avataaar)}' href='#curvy_path2' />""" +
          hairColor(avataaar, "curvy_mask2") +
          """<path
        ...
        <g id='Top/Long-Hair/Dreads' mask='url(#long_mask2)'>
          ...
          """
            <g
              ...
              <use id='No-Woman' fill='${hairColorHex(avataaar)}' href='#long_path2' />""" +
          hairColor(avataaar, "dread_mask2") +
          """<path
        ...
        <g id='Top/Long-Hair/Fro' mask='url(#fro_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            ...
            <g
              ...
              <use fill='${hairColorHex(avataaar)}' href='#fro_path2' />""" +
          hairColor(avataaar, "fro_mask2") +
          """</g>""" +
          facialHair(avataaar) +
          accessorySvg(avataaar) +
          """</g>
        ...
        <g id='Top/Long-Hair/Fro-+-Band' mask='url(#band_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            ...
            <use
              id='Hair'
              stroke='none'
              fill='${hairColorHex(avataaar)}'
              fill-rule='evenodd'
              href='#band_path2'
            />""" +
          hairColor(avataaar, "band_mask2") +
          """<path
        ...
        <g id='Top/Long-Hair/Long-but-not-too-long' mask='url(#long_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            <g id='Behind' stroke-width='1' fill-rule='evenodd'>
              ...
              <use id='Combined-Shape' fill='${hairColorHex(avataaar)}' href='#long_path2' />""" +
          hairColor(avataaar, "long_mask2") +
          """</g>
            <g
              id='Top'
              opacity='0.439990942'
        ...
        <g id='Top/Long-Hair/Mia-Wallace' mask='url(#wall_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            ...
            <g
              ...
              <use id='Combined-Shape' fill='${hairColorHex(avataaar)}' href='#wall_path2' />""" +
          hairColor(avataaar, "wall_mask2") +
          """</g>""" +
          facialHair(avataaar) +
          accessorySvg(avataaar) +
          """</g>
        ...
        <g id='Top/Long-Hair/Straight' mask='url(#long_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            <g
              ...
              <use id='Mask-Hair' fill='${hairColorHex(avataaar)}' href='#long_path2' />""" +
          hairColor(avataaar, "long_mask2") +
          """</g>
            <path
        ...
        <g id='Top/Long-Hair/Straight' mask='url(#long_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            <g
              ...
              <use fill='${hairColorHex(avataaar)}' href='#long_path2' />""" +
          hairColor(avataaar, "long_mask2") +
          """</g>
            <path
        ...
        <g id='Top/Long-Hair/Straight-+-Strand' mask='url(#strand_mask1)'>
          <g transform='translate(-1.000000, 0.000000)'>
            <g
              ...
              <use fill='${hairColorHex(avataaar)}' href='#strand_path2' />""" +
          hairColor(avataaar, "strand_mask2") +
          """</g>
            <path
        ...
        <g id='Top/Short-Hair/Dreads-02' mask='url(#short_mask2)'>
          ...
          """
            <g
              ...
              <use id='Dreads' fill='${hairColorHex(avataaar)}' href='#short_path3' />""" +
          hairColor(avataaar, "short_mask1") +
          """</g>""" +
          accessorySvg(avataaar) +
          """</g>
        </g>
        ...
        <g id='Top/Short-Hair/Frizzle' mask='url(#fizzle_mask2)'>
          ...
          """<mask id="fizzle_mask1" fill='white'>
            ...
            <use
              ...
              fill-rule='evenodd'
              href='#fizzle_path1'/>""" +
          hairColor(avataaar, "fizzle_mask1") +
          accessorySvg(avataaar) +
          """</g>
        </g>
      </g>""";
        ...
        <g id='Top/Short-Hair/Shaggy-Mullet' mask='url(#mullet_mask1)'>
          ...
          """<mask id="mullet_mask2" fill='white'>
            ...
            <use
              ...
              href='#mullet_path2'
            />""" +
          hairColor(avataaar, "mullet_mask2") +
          """<path
        ...
        <g id='Top/Short-Hair/Short-Curly' mask='url(#curly_mask2)'>
          ...
          """<mask id="curly_mask1" fill='white'>
            ...
            <use
              ...
              href='#curly_path1'
            />""" +
          hairColor(avataaar, "curly_mask1") +
          accessorySvg(avataaar) +
          """</g>
        </g>
      </g>""";
        ...
        <g id='Top/Short-Hair/Short-Round' mask='url(#round_mask2)'>
          ...
          """
            ...
            <use
              ...
              href='#round_mask1'
            />""" +
          hairColor(avataaar, "round_mask1") +
          accessorySvg(avataaar) +
          """</g>
        </g>
      </g>""";
        ...
        <g id='Top/Short-Hair/Short-Waved' mask='url(#waved_mask2)'>
          ...
          """<mask id="waved_mask1" fill='white'>
            ...
            <use
              ...
              href='#waved_path1'
            />""" +
          hairColor(avataaar, "waved_mask1") +
          accessorySvg(avataaar) +
          """</g>
        </g>
      </g>""";
        ...
        <g id='Top/Short-Hair/The-Caesar' mask='url(#caesar_mask1)'>
          ...
          """
            <g
              ...
              <use id='Caesar' fill='${hairColorHex(avataaar)}' href='#caesar_path2' />""" +
          hairColor(avataaar, "caesar_mask2") +
          """</g>""" +
          accessorySvg(avataaar) +
          """</g>
        </g>
...
String facialHair(avataaar) {
  switch (avataaar?.facialHair?.facialHairType) {
  ...
  <g
        ...
        <use
          id='Lite-Beard'
          fill='${facialHairColorHex(avataaar)}'
          fill-rule='evenodd'
          href='#ligh_path'
        />""" +
          facialHairColor(avataaar, "light_mask") +
          """</g>""";
    case FacialHairType.BeardMagestic:
      ...
      <g
        ...
        <use
          ...
          href='#majestic_path'
        />""" +
          facialHairColor(avataaar, "majestic_mask") +
          """</g>""";
    case FacialHairType.MoustacheFancy:
      ...
      <g
        ...
        <use
          ...
          href='#fancy_path'
        />""" +
          facialHairColor(avataaar, "fancy_mask") +
          """</g>""";
    case FacialHairType.MoustacheMagnum:
      ...
      <g
        ...
        <use
          ...
          href='#magnum_path'
        />""" +
          facialHairColor(avataaar, "magnum_mask") +
          """</g>""";
    default:
      return "";
  }
